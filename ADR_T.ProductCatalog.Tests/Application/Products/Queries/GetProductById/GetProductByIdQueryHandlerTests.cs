...
public class GetProductByIdQueryHandlerTests
{
    ...
    public async Task Handle_ShouldReturnProductDto_WhenProductExists()
    {
        ...
        var product = new Product("Test Product", "Test Description", 99.99m, 50, categoryId, null);
        var productDto = new ProductDto { Id = productId, Name = "Test Product" };

        // Usar reflexión para establecer el Id ya que la propiedad Id es de solo lectura.
