        ...
        public async Task SeedAsync()
        {
            try
            {
                if ((await _context.Database.GetPendingMigrationsAsync()).Any())
                {
                    ...
                    _logger.LogInformation("Migraciones de base de datos aplicadas exitosamente.");
                }
        ...
        private async Task SeedCatalogAsync()
        {
            if (!_context.Categories.Any())
            {
                ...
                if (!_context.Products.Any())
                {
                    ...
                    {
                        new Product("Laptop Pro X", "Laptop de alto rendimiento para profesionales.", 1499.99m, 50, electronicaCategory.Id, "https://example.com/images/laptop.jpg"),
                        new Product("Smartphone Z", "El último modelo con cámara de alta resolución.", 899.50m, 120, electronicaCategory.Id, "https://example.com/images/phone.jpg"),
                        new Product("El Legado del Viento", "Una novela de fantasía épica.", 22.95m, 200, librosCategory.Id, "https://example.com/images/book1.jpg")
                    };
